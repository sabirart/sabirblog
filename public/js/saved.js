document.addEventListener('DOMContentLoaded', () => {
    ...
    window.initializeSaveButtons = () => {
        ...
        saveButtons.forEach(button => {
            ...
            button._saveHandler = (e) => {
                ...
                // Update all save buttons for this postId
                document.querySelectorAll(`.save-btn[data-post-id="${postId}"]`).forEach(btn => {
                    const btnIcon = btn.querySelector('i');
                    if (btnIcon) {
                        btnIcon.className = localStorage.getItem(`saved-${postId}`) ? 'fas fa-bookmark' : 'far fa-bookmark';
                    }
                });
            };
    ...
    window.renderPostOverlay = (postId) => {
        ...
        closeButton.onclick = closeOverlay(window.overlays.articleOverlay, closeButton, '.article-overlay-container');
        ...
        // Initialize save buttons after rendering the overlay
        window.initializeSaveButtons();
    ...
    window.renderSavedArticles = () => {
        ...
        // Initialize save buttons after rendering the saved articles overlay
        window.initializeSaveButtons();
        window.initializeDeleteButtons();
    };
